...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m517containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UInt.m98boximpl(m518getpVg5ArA(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m519indexOfWZ4Q5Ns(((UInt) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m520lastIndexOfWZ4Q5Ns(((UInt) obj).getData());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m165getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection, java.util.Collection
    public boolean isEmpty() {
        return UIntArray.m167isEmptyimpl(this.$this_asList);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public boolean m517containsWZ4Q5Ns(int element) {
        return UIntArray.m160containsWZ4Q5Ns(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public int m518getpVg5ArA(int index) {
        return UIntArray.m164getpVg5ArA(this.$this_asList, index);
    }

    /* JADX INFO: renamed from: indexOf-WZ4Q5Ns, reason: not valid java name */
    public int m519indexOfWZ4Q5Ns(int element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: lastIndexOf-WZ4Q5Ns, reason: not valid java name */
    public int m520lastIndexOfWZ4Q5Ns(int element) {
