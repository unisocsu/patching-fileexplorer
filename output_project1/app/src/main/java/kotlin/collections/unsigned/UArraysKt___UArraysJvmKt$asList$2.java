...
public final class UArraysKt___UArraysJvmKt$asList$2 extends AbstractList<ULong> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m521containsVKZWuLQ(((ULong) obj).getData());
        }
        return false;
    }
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return ULong.m177boximpl(m522getsVKNKU(i));
    }

    @Override // kotlin.collections.AbstractList, java.util.List
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof ULong) {
            return m523indexOfVKZWuLQ(((ULong) obj).getData());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof ULong) {
            return m524lastIndexOfVKZWuLQ(((ULong) obj).getData());
        }
        return -1;
    }
    ...
    public boolean m521containsVKZWuLQ(long element) {
        return ULongArray.m239containsVKZWuLQ(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: get-s-VKNKU, reason: not valid java name */
    public long m522getsVKNKU(int index) {
        return ULongArray.m243getsVKNKU(this.$this_asList, index);
    }

    /* JADX INFO: renamed from: indexOf-VKZWuLQ, reason: not valid java name */
    public int m523indexOfVKZWuLQ(long element) {
        return ArraysKt.indexOf(this.$this_asList, element);
    }

    /* JADX INFO: renamed from: lastIndexOf-VKZWuLQ, reason: not valid java name */
    public int m524lastIndexOfVKZWuLQ(long element) {
