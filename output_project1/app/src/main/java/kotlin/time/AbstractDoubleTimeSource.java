...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1325elapsedNowUwyO8pc() {
            return Duration.m1370minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1328plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1371plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1327minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m1340equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m1367isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m1438getZEROUwyO8pc();
                    }
                    long jM1370minusLRDsOJo = Duration.m1370minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m1340equalsimpl0(duration, Duration.m1388unaryMinusUwyO8pc(jM1370minusLRDsOJo)) ? Duration.INSTANCE.m1438getZEROUwyO8pc() : Duration.m1371plusLRDsOJo(duration, jM1370minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1340equalsimpl0(mo1327minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1438getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1363hashCodeimpl(Duration.m1371plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1384toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1438getZEROUwyO8pc(), null);
    }
}
