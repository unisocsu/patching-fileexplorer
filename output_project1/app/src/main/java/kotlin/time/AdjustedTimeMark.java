...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1326minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1472minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo1325elapsedNowUwyO8pc() {
        return Duration.m1370minusLRDsOJo(this.mark.mo1325elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1328plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1371plusLRDsOJo(this.adjustment, duration), null);
    }
}
