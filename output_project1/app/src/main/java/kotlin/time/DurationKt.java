...
public final class DurationKt {
    ...
    private static final long m1462timesmvk6XK0(int i, long j) {
        return Duration.m1373timesUwyO8pc(j, i);
    }
    ...
    private static final long m1461timeskIfJnKk(double d, long j) {
        return Duration.m1372timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM1438getZEROUwyO8pc = Duration.INSTANCE.m1438getZEROUwyO8pc();
        ...
        if (str2.charAt(length2) == 'P') {
            ...
            while (i < length) {
                if (str2.charAt(i) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM1371plusLRDsOJo = Duration.m1371plusLRDsOJo(jM1438getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM1438getZEROUwyO8pc = Duration.m1371plusLRDsOJo(jM1371plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM1438getZEROUwyO8pc = Duration.m1371plusLRDsOJo(jM1438getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    z6 = z6;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, Math.max(length - length2, 8), true)) {
                jM1438getZEROUwyO8pc = Duration.INSTANCE.m1436getINFINITEUwyO8pc();
            } else {
                boolean z7 = !z4;
                ...
                while (length2 < length) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM1371plusLRDsOJo2 = Duration.m1371plusLRDsOJo(jM1438getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM1438getZEROUwyO8pc = Duration.m1371plusLRDsOJo(jM1371plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM1438getZEROUwyO8pc = Duration.m1371plusLRDsOJo(jM1438getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1388unaryMinusUwyO8pc(jM1438getZEROUwyO8pc) : jM1438getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1335constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1335constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1335constructorimpl((j << 1) + ((long) i));
    }
