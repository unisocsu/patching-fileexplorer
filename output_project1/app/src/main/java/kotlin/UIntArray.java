...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static final /* synthetic */ UIntArray m157boximpl(int[] iArr) {
        return new UIntArray(iArr);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static int[] m159constructorimpl(int[] storage) {
        Intrinsics.checkNotNullParameter(storage, "storage");
        return storage;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m162equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).getStorage());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m163equalsimpl0(int[] iArr, int[] iArr2) {
    ...
    public static int m166hashCodeimpl(int[] iArr) {
        return Arrays.hashCode(iArr);
    }

    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m170toStringimpl(int[] iArr) {
    ...
    public boolean m171addWZ4Q5Ns(int i) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public boolean equals(Object obj) {
        return m162equalsimpl(this.storage, obj);
    }

    @Override // java.util.Collection
    public int hashCode() {
        return m166hashCodeimpl(this.storage);
    }
    ...
    public String toString() {
        return m170toStringimpl(this.storage);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m172containsWZ4Q5Ns(((UInt) obj).getData());
        }
        return false;
    }
    ...
    public static int[] m158constructorimpl(int i) {
        return m159constructorimpl(new int[i]);
    }

    /* JADX INFO: renamed from: get-pVg5ArA, reason: not valid java name */
    public static final int m164getpVg5ArA(int[] iArr, int i) {
        return UInt.m104constructorimpl(iArr[i]);
    }

    /* JADX INFO: renamed from: set-VXSXFK8, reason: not valid java name */
    public static final void m169setVXSXFK8(int[] iArr, int i, int i2) {
        iArr[i] = i2;
    }

    /* JADX INFO: renamed from: getSize-impl, reason: not valid java name */
    public static int m165getSizeimpl(int[] iArr) {
        return iArr.length;
    }
    ...
    public int size() {
        return m165getSizeimpl(this.storage);
    }

    /* JADX INFO: renamed from: iterator-impl, reason: not valid java name */
    public static java.util.Iterator<UInt> m168iteratorimpl(int[] iArr) {
        return new Iterator(iArr);
    }

    @Override // java.util.Collection, java.lang.Iterable
    public java.util.Iterator<UInt> iterator() {
        return m168iteratorimpl(this.storage);
    }
    ...
    private static final class Iterator implements java.util.Iterator<UInt>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ UInt next() {
            return UInt.m98boximpl(m174nextpVg5ArA());
        }
    ...
    public boolean m172containsWZ4Q5Ns(int i) {
        return m160containsWZ4Q5Ns(this.storage, i);
    }

    /* JADX INFO: renamed from: contains-WZ4Q5Ns, reason: not valid java name */
    public static boolean m160containsWZ4Q5Ns(int[] iArr, int i) {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m161containsAllimpl(this.storage, elements);
    }

    /* JADX INFO: renamed from: containsAll-impl, reason: not valid java name */
    public static boolean m161containsAllimpl(int[] iArr, Collection<UInt> elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
    ...
    public static boolean m167isEmptyimpl(int[] iArr) {
        return iArr.length == 0;
    }

    @Override // java.util.Collection
    public boolean isEmpty() {
        return m167isEmptyimpl(this.storage);
    }
}
