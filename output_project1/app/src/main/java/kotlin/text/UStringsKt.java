...
public final class UStringsKt {
    ...
    public static final String m1322toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1324toStringolVBNx4(short s, int i) {
    ...
    public static final String m1323toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1321toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ IntCompanionObject.MIN_VALUE, UInt.m104constructorimpl(KotlinVersion.MAX_COMPONENT_VALUE) ^ IntCompanionObject.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ IntCompanionObject.MIN_VALUE, UInt.m104constructorimpl(65535) ^ IntCompanionObject.MIN_VALUE) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM104constructorimpl = UInt.m104constructorimpl(i);
        int iM$1 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ IntCompanionObject.MIN_VALUE, iM$1 ^ IntCompanionObject.MIN_VALUE) > 0) {
                if (iM$1 == 119304647) {
                    iM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1, iM104constructorimpl);
                    if (Integer.compare(i3 ^ IntCompanionObject.MIN_VALUE, iM$1 ^ IntCompanionObject.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM104constructorimpl2 = UInt.m104constructorimpl(i3 * iM104constructorimpl);
            int iM104constructorimpl3 = UInt.m104constructorimpl(UInt.m104constructorimpl(iDigitOf) + iM104constructorimpl2);
            if (Integer.compare(iM104constructorimpl3 ^ IntCompanionObject.MIN_VALUE, iM104constructorimpl2 ^ IntCompanionObject.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM104constructorimpl3;
        }
        return UInt.m98boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM183constructorimpl = ULong.m183constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM183constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM183constructorimpl2 = ULong.m183constructorimpl(j * jM183constructorimpl);
            long jM183constructorimpl3 = ULong.m183constructorimpl(ULong.m183constructorimpl(((long) UInt.m104constructorimpl(iDigitOf)) & 4294967295L) + jM183constructorimpl2);
            if (Long.compare(jM183constructorimpl3 ^ Long.MIN_VALUE, jM183constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM183constructorimpl3;
        }
        return ULong.m177boximpl(j);
    }
}
