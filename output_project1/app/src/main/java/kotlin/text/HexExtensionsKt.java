...
public final class HexExtensionsKt {
    ...
    /* JADX WARN: Code duplicated, block: B:30:0x0083 A[SYNTHETIC] */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        if (RangesKt.intRangeContains((ClosedRange<Integer>) new IntRange(0, IntCompanionObject.MAX_VALUE), j)) {
            return (int) j;
        }
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m229toStringimpl(ULong.m183constructorimpl(j))));
    }
