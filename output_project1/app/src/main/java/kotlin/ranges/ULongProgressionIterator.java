...
final class ULongProgressionIterator implements Iterator<ULong>, KMappedMarker {
    ...
    private ULongProgressionIterator(long j, long j2, long j3) {
        ...
        this.hasNext = z;
        this.step = ULong.m183constructorimpl(j3);
        this.next = this.hasNext ? j : j2;
    }

    @Override // java.util.Iterator
    public /* bridge */ /* synthetic */ ULong next() {
        return ULong.m177boximpl(m1245nextsVKNKU());
    }

    /* JADX INFO: renamed from: next-s-VKNKU, reason: not valid java name */
    public long m1245nextsVKNKU() {
        long j = this.next;
        if (j != this.finalElement) {
            this.next = ULong.m183constructorimpl(this.step + j);
        } else {
            if (!this.hasNext) {
