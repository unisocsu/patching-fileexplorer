...
public final class UnsignedKt {
    ...
    public static final int m360uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m104constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }
    ...
    public static final long m362ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? ULong.m183constructorimpl(0L) : ULong.m183constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m183constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m183constructorimpl(j3 + ((long) (Long.compare(ULong.m183constructorimpl(j - (j3 * j2)) ^ Long.MIN_VALUE, ULong.m183constructorimpl(j2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)));
    }
    ...
    public static final long m363ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compare(j ^ Long.MIN_VALUE, j2 ^ Long.MIN_VALUE) < 0 ? j : ULong.m183constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m183constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compare(ULong.m183constructorimpl(j3) ^ Long.MIN_VALUE, ULong.m183constructorimpl(j2) ^ Long.MIN_VALUE) < 0) {
            j2 = 0;
        }
        return ULong.m183constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m104constructorimpl((int) d);
        }
        double d2 = IntCompanionObject.MAX_VALUE;
        Double.isNaN(d2);
        return UInt.m104constructorimpl(UInt.m104constructorimpl((int) (d - d2)) + UInt.m104constructorimpl(IntCompanionObject.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m183constructorimpl((long) d);
        }
        return ULong.m183constructorimpl(ULong.m183constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
